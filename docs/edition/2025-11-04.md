...
Now that 4.0 has been out for a bit — what’s your favorite feature?
Jonas, one of our LoopFollow SuperDevelopers, uses volume-button snooze all the time: “In a company meeting, I managed to snooze super fast ”
Your turn — what’s your 4.0 story?
• Did push feedback calm the “was it received?” nerves?
• Snooze All from the new Snoozer Bar on a long drive?
• QR share to spin up a second phone in seconds?
Drop a mini story:
— What happened?
...
If you are only using Browser Builds, and you have not been bothering to keep your Xcode version up to date, and you need to free up space, you can remove Xcode from your Mac:
...
Our generous donors have given $41,260.00 so far, including many $10 contributions! Thank you! Let’s keep going towards our goal of $50K!

Your support is helping Devs and support staff from these countries to be at the Hack:
...
When injecting air into the insulin vial, before drawing up insulin, hold the vial upright so the air goes directly into the headspace and doesn't have to pass through the liquid. Then flip and draw up the insulin slowly.

There will still be a large bubble at the top after you draw in the insulin. You can try to get most of that bubble out but it is not critical. Next, invert the syringe so it's needle down, flick it a couple of times to get any residual bubbles (there will be some!) to rise to the top. Keep the needle side down while you fill the pod. Those few bubbles will remain in the syringe.
